...
func TestRotate(t *testing.T) {
	...
	dial = day01.RotateDial(dial, day01.Left, 68)
	assert.Equal(t, 82, dial)
	dial = day01.RotateDial(dial, day01.Left, 30)
	assert.Equal(t, 52, dial)
	dial = day01.RotateDial(dial, day01.Right, 48)
	assert.Equal(t, 0, dial)
	dial = day01.RotateDial(dial, day01.Left, 5)
	assert.Equal(t, 95, dial)
	dial = day01.RotateDial(dial, day01.Right, 60)
	assert.Equal(t, 55, dial)
	dial = day01.RotateDial(dial, day01.Left, 55)
	assert.Equal(t, 0, dial)
	dial = day01.RotateDial(dial, day01.Left, 1)
	assert.Equal(t, 99, dial)
	dial = day01.RotateDial(dial, day01.Left, 99)
	assert.Equal(t, 0, dial)
	dial = day01.RotateDial(dial, day01.Right, 14)
	assert.Equal(t, 14, dial)
	dial = day01.RotateDial(dial, day01.Left, 82)
...
func TestGetPassword(t *testing.T) {
	...
	var password = day01.GetPassword(lines)
